...
while True:
    ...
    if choice not in ["1","2","3","4","5","6"]:
        ...
        searc_name = input("Enter the name of the student to search: ")
        searched_user = []
        is_found = False
        for student in students:
            if student[1] == searc_name:
        ...
        update_det = input("Enter the column for which you want to update the details: ")
